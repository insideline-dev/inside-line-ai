Synthesize the following 11 agent evaluations into a final investment memo:
...
The following recommendations were produced by individual evaluation agents. Incorporate the most impactful ones into your nextSteps and founderReport. Remove duplicates and prioritize by importance for a {{stage}} company.

{{evaluationRecommendations}}

{{adminGuidance}}

Synthesize all 11 analyses into a cohesive investment memo. Lead with what matters most for a {{stage}} company. Check for cross-section contradictions before writing. Take a clear position.