...
export const AI_PROMPT_CATALOG: Record<AiPromptKey, PromptCatalogEntry> = {
  ...
  "evaluation.team": {
    ...
    defaultSystemPrompt: [
      ...
      "",
      "=== TEAM COMPOSITION: FUNCTIONAL COVERAGE ===",
      "Assess whether the team COLLECTIVELY covers each core function. One person can cover multiple functions.",
      "For each function, output: - covered: true/false",
      "",
      "Functions:",
  ...
  "synthesis.final": {
    ...
    defaultSystemPrompt: [
      ...
      "",
      "## IMPORTANT: Narrative Purity",
      "Do NOT mention numeric score, confidence level, percentages, or any 'X/100' notation in executiveSummary, investorMemo.section content, founderReport.section content, narrativeSummary, memoNarrative, or feedback prose.",
