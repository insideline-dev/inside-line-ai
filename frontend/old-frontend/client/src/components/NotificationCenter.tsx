...
export function NotificationCenter({ basePath = "" }: NotificationCenterProps) {
            ...
            notifications.slice(0, 20).map((notification) => (
              ...
              >
                {notification.startupId ? (
                  <Link href={`${basePath}/startup/${notification.startupId}`} className="flex items-start gap-3 w-full">
