...
- DATA GAPS: What you CANNOT assess from available data — list specific diligence items (corporate structure, cap table, IP assignment, governance, contract risk)
