...
const PIPELINE_STAGES: AiFlowStageDefinition[] = [
  ...
  },
  {
    ...
    nodeIds: ["synthesis_memo", "synthesis_report"],
  },
  {
    id: "stage_6_matching",
...
const PIPELINE_NODES: AiFlowNodeDefinition[] = [
  ...
  {
    id: "synthesis_memo",
    label: "Memo Synthesis",
    description: "Generate full investor memo with 11 sections, executive summary, and due diligence areas.",
    kind: "prompt",
    promptKeys: ["synthesis.memo"],
    inputs: [{ label: "All evaluation outputs", type: "object" }],
    outputs: [
      { label: "Investor memo", type: "object" },
      { label: "Executive summary", type: "text" },
      { label: "Due diligence areas", type: "array" },
    ],
  },
  {
    id: "synthesis_report",
    label: "Report Synthesis",
    description: "Generate deal snapshot, strengths, risks, exit scenarios, and founder report.",
    kind: "prompt",
    promptKeys: ["synthesis.report"],
    inputs: [
      { label: "Investor memo", type: "object" },
      { label: "All evaluation outputs", type: "object" },
    ],
    outputs: [
      { label: "Deal snapshot", type: "text" },
      { label: "Key strengths", type: "array" },
      { label: "Key risks", type: "array" },
      { label: "Exit scenarios", type: "array" },
      { label: "Founder report", type: "object" },
    ],
  },
  {
    id: "matching_thesis",
...
const PIPELINE_EDGES: AiFlowEdgeDefinition[] = [
  ...
  { from: "evaluation_team", to: "synthesis_memo" },
  { from: "evaluation_market", to: "synthesis_memo" },
  { from: "evaluation_product", to: "synthesis_memo" },
  { from: "evaluation_traction", to: "synthesis_memo" },
  { from: "evaluation_business_model", to: "synthesis_memo" },
  { from: "evaluation_gtm", to: "synthesis_memo" },
  { from: "evaluation_financials", to: "synthesis_memo" },
  { from: "evaluation_competitive_advantage", to: "synthesis_memo" },
  { from: "evaluation_legal", to: "synthesis_memo" },
  { from: "evaluation_deal_terms", to: "synthesis_memo" },
  { from: "evaluation_exit_potential", to: "synthesis_memo" },
  { from: "synthesis_memo", to: "synthesis_report" },
  { from: "synthesis_report", to: "matching_thesis" },
];
