...
Data gaps: What couldn't be verified or assessed from the available inputs? (e.g., incomplete LinkedIn profiles, no research data on key hires, org depth not visible)
